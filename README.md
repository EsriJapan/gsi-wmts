...
国土地理院は 2023年10月時点のデータソースによる更新をもってデータ更新を停止しています。

そのため、利用できるのは地理院地図の layers.txt に掲載されているレイヤーのうち、WMTS で配信可能なレイヤーのみです。

地理院地図掲載のすべてのレイヤーが参照できるわけではありません。

また、この WMTS のメタデータの今後の更新は未定です。

本メタデータは予告なく削除、変更を行う場合があります。ご了承ください。
